...
<body class="min-h-screen bg-[#c9d1da]">
    ...
    <div class="min-h-screen grid grid-cols-1 lg:grid-cols-2">
        ...
        <section
            class="bg-[#d0d6dd] px-6 sm:px-10 md:px-16 py-10 sm:py-12 flex flex-col justify-center order-2 lg:order-1">
        ...
        <section
            class="relative overflow-hidden bg-gradient-to-br from-[#aeb8c4] via-[#566985] to-[#1e3150] text-white px-6 sm:px-10 md:px-14 py-12 sm:py-16 flex items-center justify-center order-1 lg:order-2">
            <div
