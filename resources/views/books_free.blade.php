...
<body class="bg-[#f4f6fa] text-slate-800 font-sans">
    ...
    <main class="max-w-7xl mx-auto px-4 pt-28 pb-10 overflow-hidden">
        <div class="text-center mb-8">
            <h1 data-aos="fade-down" data-aos-duration="1000" class="text-3xl md:text-4xl font-black text-slate-800">Koleksi Buku Gratis</h1>
            <p data-aos="fade-up" data-aos-delay="100" class="text-slate-500 mt-2">Baca dan download buku gratis kapan saja.</p>
            ...
            <form data-aos="fade-up" data-aos-delay="300" method="GET" action="{{ route('books.free') }}"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            @empty
                <p data-aos="fade-up" class="text-sm text-slate-500 col-span-full text-center py-10">Belum ada buku gratis.</p>
            @endforelse
        </div>

        <div data-aos="fade-up" data-aos-offset="0" class="mt-8">{{ $freeBukus->links() }}</div>
    </main>
