...
<body class="font-sans">
    ...
    <section class="bg-slate-200 py-20 overflow-hidden">
        <div class="max-w-7xl mx-auto px-6 text-center">

            <h2 data-aos="fade-up" data-aos-duration="1000" class="text-2xl md:text-3xl font-bold tracking-wide mb-14">
                ABOUT US
            </h2>

            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 place-items-center">
                <img data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100" src="{{ asset('img/about-pic1.jpg') }}" class="w-72 h-72 object-cover rounded-2xl shadow-lg">

                <img data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300" src="{{ asset('img/about-pic2.jpg') }}" class="w-72 h-72 object-cover rounded-2xl shadow-xl">

                <img data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500" src="{{ asset('img/about-pic3.jpg') }}" class="w-72 h-72 object-cover rounded-2xl shadow-lg">
            </div>

        </div>
    </section>

    <section class="bg-slate-200 pb-24 overflow-hidden">
        <div class="max-w-6xl mx-auto px-6">

            <div data-aos="fade-up" data-aos-duration="1000" class="bg-white rounded-2xl shadow-lg p-10 md:p-14 text-center">
    ...
    <section class="bg-white py-24 overflow-hidden">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div data-aos="fade-right" data-aos-duration="1000" class="bg-slate-200 rounded-2xl shadow-lg p-10 md:p-12 text-center">
                ...
                <div data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200" class="bg-slate-200 rounded-2xl shadow-lg p-10 md:p-12 text-center">
                    <h3 class="text-2xl font-bold mb-6 tracking-wide">
                        MISSION
                    </h3>
    ...
    <script>
        // Inisialisasi AOS
        AOS.init({
            once: true, // Animasi berjalan satu kali saja
            offset: 100, // Trigger animasi sedikit lebih awal sebelum elemen terlihat penuh
        });
